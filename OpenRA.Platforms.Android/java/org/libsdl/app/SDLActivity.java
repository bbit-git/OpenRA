...
public class SDLActivity extends Activity implements View.OnSystemUiVisibilityChangeListener {
     ...
     * 
     * @return names of shared libraries to be loaded (e.g. "SDL2", ).
     */
...
class SDLMain implements Runnable {
    @Override
    public void run() {
        android.util.Log.v("SDL", "SDLMain: delegating to OpenRA game loop");
        Activity singleton = SDLActivity.mSingleton;
        if (singleton == null) {
            android.util.Log.e("SDL", "SDLMain: mSingleton is null, cannot start game loop");
            return;
        }
        try {
            java.lang.reflect.Method m = singleton.getClass().getMethod("runGameLoop");
            m.invoke(singleton);
        } catch (NoSuchMethodException e) {
            android.util.Log.e("SDL",
                    "SDLMain: runGameLoop() not found on " + singleton.getClass().getName() + ": " + e);
        } catch (Exception e) {
            android.util.Log.e("SDL", "SDLMain: runGameLoop() threw: " + e);
        }
    }
}
