## campaign.lua
objective-failed = Cil nesplnen
objective-completed = Cil splnen

primary = Primarni
secondary = Sekundarni

new-primary-objective = New Primarni Objective
new-secondary-objective = New Sekundarni Objective
...
repair-two-southern-bridges = Opravit the two southern bridges.
