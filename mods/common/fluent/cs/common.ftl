...
notification-timeout-dropped-in = {$player} bude odpojen za {$timeout} sekund.
...
notification-chat-temp-disabled = Chat je dočasně zakázán na {$remaining} sekund.
...
dialog-vote-kick =
    ...
    .prompt = Tento hráč se nebude moci znovu připojit ke hře.
    .prompt-break-bots = Přidané boty budou odpojeny. Chcete pokračovat?
    .vote-start = Zahájit hlasování
    .vote-for = Hlasovat PRO
    .vote-against = Hlasovat PROTI
    .vote-cancel = Zdržet se hlasování
...
label-chat-availability = Chat je k dispozici za {$seconds} sekund.
...
auto-save-interval =
    .disabled = Vypnuto
    .options = {$minutes} minut
    .minute-options = {$minutes} minut
...
label-player-count = {$players} hráčů
label-map-size-huge = Obrovská
label-map-size-large = Velká
label-map-size-medium = Střední
label-map-size-small = Malá
label-map-searching-count = Hledání ({$count})
label-map-unavailable-count = Nedostupné ({$count})
...
selected-units-across-screen = Vybrat všechny jednotky typu {$type} na obrazovce

selected-units-across-map = Vybrat všechny jednotky typu {$type} na mapě
...
## ServerListLogic
label-players-online-count = {$players} hráčů online
...
label-players-count = {$players} hráčů

label-bots-count = {$bots} botů
...
label-spectators-count = {$spectators} diváků
...
label-other-players-count = {$players} ostatních hráčů

label-in-progress-for = Probíhá {$time}
...
## EditorResourceBrush
notification-added-resource = Přidáno { $amount } { $resource }.
...
notification-added-marker-tiles-markers =
    ...
    .purple = fialový
    .magenta = purpurový
notification-added-marker-tiles = Přidáno { $count } značkovacích dílků.
notification-removed-marker-tiles = Odstraněno { $count } značkovacích dílků.
notification-cleared-selected-marker-tiles = Vymazány vybrané značkovací dílky.
...
keycode =
    ...
    .kp_divide = Numerická klávesnice /
    .kp_multiply = Numerická klávesnice *
    .kp_minus = Numerická klávesnice -
    .kp_plus = Numerická klávesnice +
    .kp_enter = Enter na numerické klávesnici
    .kp_1 = Numerická klávesnice 1
    .kp_2 = Numerická klávesnice 2
    .kp_3 = Numerická klávesnice 3
    .kp_4 = Numerická klávesnice 4
    .kp_5 = Numerická klávesnice 5
    .kp_6 = Numerická klávesnice 6
    .kp_7 = Numerická klávesnice 7
    .kp_8 = Numerická klávesnice 8
    .kp_9 = Numerická klávesnice 9
    .kp_0 = Numerická klávesnice 0
    .kp_period = Numerická klávesnice .
    .application = Aplikace
    .power = Napájení
    .kp_equals = Numerická klávesnice =
    .f13 = F13
    .f14 = F14
    .f15 = F15
    .f16 = F16
    ...
    .kp_comma = Numerická klávesnice ,
    .kp_equalsas400 = Numerická klávesnice (AS400)
    .alterase = AltErase
    .sysreq = SysReq
    .cancel = Zrušit
    .clear = Vymazat
    ...
    .out = Ven
    .oper = Oper
    .clearagain = Vymazat / Znovu
    .crsel = CrSel
    .exsel = ExSel
    .kp_00 = Numerická klávesnice 00
    .kp_000 = Numerická klávesnice 000
    .thousandsseparator = Oddělovač tisíců
    .decimalseparator = Desetinný oddělovač
    .currencyunit = Měnová jednotka
    .currencysubunit = Měnová podjednotka
    .kp_leftparen = Numerická klávesnice (
    .kp_rightparen = Numerická klávesnice )
    .kp_leftbrace = Numerická klávesnice { $brace }
    .kp_rightbrace = Numerická klávesnice { $brace }
    .kp_tab = Numerická klávesnice Tab
    .kp_backspace = Numerická klávesnice Backspace
    .kp_a = Numerická klávesnice A
    .kp_b = Numerická klávesnice B
    .kp_c = Numerická klávesnice C
    .kp_d = Numerická klávesnice D
    .kp_e = Numerická klávesnice E
    .kp_f = Numerická klávesnice F
    .kp_xor = Numerická klávesnice XOR
    .kp_power = Numerická klávesnice ^
    .kp_percent = Numerická klávesnice %
    .kp_less = Numerická klávesnice <
    .kp_greater = Numerická klávesnice >
    .kp_ampersand = Numerická klávesnice &
    .kp_dblampersand = Numerická klávesnice &&
    .kp_verticalbar = Numerická klávesnice |
    .kp_dblverticalbar = Numerická klávesnice ||
    .kp_colon = Numerická klávesnice :
    .kp_hash = Numerická klávesnice #
    .kp_space = Numerická klávesnice Mezerník
    .kp_at = Numerická klávesnice @
    .kp_exclam = Numerická klávesnice !
    .kp_memstore = Numerická klávesnice MemStore
    .kp_memrecall = Numerická klávesnice MemRecall
    .kp_memclear = Numerická klávesnice MemClear
    .kp_memadd = Numerická klávesnice MemAdd
    .kp_memsubtract = Numerická klávesnice MemSubtract
    .kp_memmultiply = Numerická klávesnice MemMultiply
    .kp_memdivide = Numerická klávesnice MemDivide
    .kp_plusminus = Numerická klávesnice +/-
    .kp_clear = Numerická klávesnice Clear
    .kp_clearentry = Numerická klávesnice ClearEntry
    .kp_binary = Numerická klávesnice binární
    .kp_octal = Numerická klávesnice osmičková
    .kp_decimal = Numerická klávesnice desítková
    .kp_hexadecimal = Numerická klávesnice šestnáctková
    .lctrl = Levý Ctrl
    .lshift = Levý Shift
    .lalt = Levý Alt
    .lgui = Levé GUI
    ...
    .ralt = Pravý Alt
    .rgui = Pravé GUI
    .mode = Přepnutí režimu
    .audionext = Další skladba
    .audioprev = Předchozí skladba
    .audiostop = Zastavit zvuk
    .audioplay = Přehrát zvuk
    .audiomute = Ztlumit zvuk
    .mediaselect = Volba médií
    .www = WWW
    .mail = Pošta
    ...
    .brightnessdown = Snížit jas
    .brightnessup = Zvýšit jas
    .displayswitch = Přepnout displej
    .kbdillumtoggle = Přepnout podsvícení klávesnice
    .kbdillumdown = Snížit podsvícení klávesnice
    .kbdillumup = Zvýšit podsvícení klávesnice
    .eject = Vysunout
    .sleep = Spánek
    .mouse4 = Myš 4
    .mouse5 = Myš 5
